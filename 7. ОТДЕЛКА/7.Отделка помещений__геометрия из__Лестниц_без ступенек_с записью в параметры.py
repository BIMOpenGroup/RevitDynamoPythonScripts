...
for s in stairs:
	...
	elems = []
	for mats_and_areas in ElementGeomFaces4(s,param_list).items():
		try:
			s.LookupParameter(mats_and_areas[0]).Set(sum(mats_and_areas[1]))
		except:
			pass		
	#test.append(ElementGeomFaces4(s,param_list).items())

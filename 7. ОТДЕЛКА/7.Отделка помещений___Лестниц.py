...
def Get_walltype_ctruct_mat_name(doc,b_element,room):
	room_func = room.LookupParameter("ROM_Номер").AsString()
...
#-------------------нужен метот для получения плоскости стены с изминёным профилем -------------------
	...
	#test2.append(boundary_surf)
	
TransactionManager.Instance.TransactionTaskDone()	
	
OUT = surface_list_all,boundary_type_by_room,boundary_by_room_level,separator_list,test3,test2